...
var RadSideDrawer = (function (_super) {
    ...
    RadSideDrawer.prototype.onNavigatingFrom = function (args) {
        if (this.getIsOpen() && this.showOverNavigation) {
            this.closeDrawer();
        }
    };
    ...
    RadSideDrawer.prototype.onMeasure = function (widthMeasureSpec, heightMeasureSpec) {
        ...
        if (this.showOverNavigation) {
            ...
            drawerWidth = utils.layout.makeMeasureSpec(utils.layout.toDevicePixels(screen_1.bounds.size.width), utils.layout.EXACTLY);
            drawerHeight = utils.layout.makeMeasureSpec(utils.layout.toDevicePixels(screen_1.bounds.size.height), utils.layout.EXACTLY);
        }
        var drawerSize = utils.layout.toDevicePixels(this.drawerContentSize);
        if (pos === 2 /* Top */ || pos === 3 /* Bottom */) {

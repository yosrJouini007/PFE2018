...
export declare module CommitMode {
    var Immediate: string;
    var OnLostFocus: string;
    var Manual: string;
}
export declare module AutoCompleteDisplayMode {
    var Plain: string;
    var Tokens: string;
}
export declare module ValidationMode {
    var Immediate: string;
    var OnLostFocus: string;
    var Manual: string;
}
export declare module DataFormLabelPosition {
    var Left: string;
    var Top: string;
}
export declare module EditorType {
    var Text: string;
    ...
    var Stepper: string;
    var Slider: string;
    var SegmentedEditor: string;
    var DatePicker: string;
    var TimePicker: string;
    var Picker: string;
    var List: string;
    var AutoCompleteInline: string;
    var Label: string;
}
/**
 * Font styles

...
var SuggestionViewCell = (function (_super) {
    ...
    SuggestionViewCell.prototype.measureCell = function (cellView) {
        if (cellView) {
            ...
            var heightSpec = view_1.layout.makeMeasureSpec(0, view_1.layout.UNSPECIFIED);
            var widthSpec = view_1.layout.makeMeasureSpec(itemWidth, view_1.layout.EXACTLY);
...
var SuggestionViewDataSourceImpl = (function (_super) {
    ...
    SuggestionViewDataSourceImpl.prototype.collectionViewNumberOfItemsInSection = function (collectionView, section) {
        ...
        return owner.suggestionView.ios.items ? owner.suggestionView.ios.items.count : 0; //todo: update to support custom DataSource object from owner
    };
...
var AutoCompleteAsyncDataSourceImpl = (function (_super) {
    ...
    AutoCompleteAsyncDataSourceImpl.prototype.autoCompleteCompletionsForString = function (autocomplete, input) {
        ...
        owner.asyncCall(input).then(function (items) {
            ...
            var nsResult = new Array();
            radAutoComplete.items = new observableArray.ObservableArray();

...
export declare module DisplayMode {
    var Tokens: string;
    var Plain: string;
}
export declare module SuggestMode {
    var Suggest: string;
    var Append: string;
    var SuggestAppend: string;
}
export declare module LayoutMode {
    var Horizontal: string;
    var Wrap: string;
}
export declare module CompletionMode {
    var StartsWith: string;
    var Contains: string;
}
export declare module AutoCompleteViewTypes {
    var ItemView: string;
}

 ...
 */
@Injectable()
export class GymsApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findGyms(data: any = {}, customHeaders?: Function): Observable<Gyms[]> {
    ...
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result.map((instances: Array<Gyms>) =>
        instances.map((instance: Gyms) => new Gyms(instance))
    );
  }
   ...
   * </em>
   */
  public gymPin(price: any = {}, os: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Gyms/gym-pin";
    let _routeParams: any = {};
    ...
    if (typeof os !== 'undefined' && os !== null) _urlParams.os = os;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }

 ...
 */
@Injectable()
export class SessionsApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getGym(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getGuest(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sessions/:id/guest";
    let _routeParams: any = {
   ...
   * </em>
   */
  public stopSession(data: any = {}, customHeaders?: Function): Observable<any> {

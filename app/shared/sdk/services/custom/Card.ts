...
export class CardApi extends BaseLoopBackApi {
   ...
   *  - `result` – `{any}` - 
   */
  public addCard(data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   *  - `result` – `{any}` - 
   */
  public deleteCard(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Cards/delete-card";
    let _routeParams: any = {};
   ...
   *  - `result` – `{any}` - 
   */
  public listCard(data: any = {}, customHeaders?: Function): Observable<any> {
